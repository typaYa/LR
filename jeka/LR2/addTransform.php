...
<nav class="navbar bg-body-tertiary" style="border: 1px solid #e3e2e2">
    <div class="container-fluid">
        <span class="navbar-brand mb-0 h1"><a href="allTransform.php">Просмотр</a></span>
    </div>
</nav>
...
<div class="container" style="display: flex;flex-direction: column;border: 1px solid #cbcaca;margin-top: 100px">
    ...
    <form action="uploadTransform.php" method="POST" enctype="multipart/form-data" style="display: flex;flex-direction: column;max-width: 100%" >
        <div class="mb-3">
        ...
        <div class="mb-3">
            <input class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" type="text" name="post" placeholder="Поставщик">
        </div>
